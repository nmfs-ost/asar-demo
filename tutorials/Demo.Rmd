...
*Note:* The dat file in the above function should be the converted dataframe from the `convert_outpout` function ran earlier in this tutorial. If you want increased customization for these tables/figures, we encourage you to run various functions in `satf` individually.
